...
#define FIELD_GETX(_x, _name)   (u32)(((_x) >> (_name##_SHIFT)) & (_name##_MASK))
#define FIELDL(_name, _v) (u32)(((u32)(_v) & (_name##_MASK)) << (_name##_SHIFT))
#define FIELDS(_name, _v) (u16)(((u16)(_v) & (_name##_MASK)) << (_name##_SHIFT))
